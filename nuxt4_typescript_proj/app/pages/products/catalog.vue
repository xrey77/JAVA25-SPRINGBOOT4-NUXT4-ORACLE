...
<div class="container-fluid bg">
    ...
    <div class="card-group">
        <div v-for="product in vardata.prods" class="col-md-4">
         <div class="card mb-3 mx-3">
            <img v-bind:src="`http://localhost:9090/products/${product.productpicture}`" class="card-img-top" alt="...">
    ...
    <div class="text-center text-warning" v-if="vardata.listMsg">{{ vardata.listMsg }}</div>
      ...
      <br/>
      <div class="text-center mb-2 text-white">Copyright 2025, All rights reserved. World Taekwondo</div>
