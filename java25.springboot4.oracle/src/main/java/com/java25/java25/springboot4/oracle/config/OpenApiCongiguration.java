...
public class OpenApiCongiguration {
	  ...
	  public OpenAPI barclaysOpenAPI() {
	    ...
	    contact.setUrl("http://localhost:9090");

	    License mitLicense = new License().name("MIT License").url("https://world-taekwondo.com/licenses/mit/");

	    Info info = new Info()
                .title("WORLD TAEKWONDO API Management")
                .version("1.0")
                .contact(contact)
