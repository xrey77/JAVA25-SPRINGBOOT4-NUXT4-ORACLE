...
import com.java25.java25.springboot4.oracle.services.JwtUserDetailsService;
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers(
                    ...
                    "/auth/**", "/public/**", "/take/**", "/error",
                    "/listproducts", "/listcatalogs", "/searchproduct","/users/**", "/products/**",
                    "/", "/index.html", "/static/**", "/images/**", "/error", "/_nuxt/**", "/server/**"
                ).permitAll()
