...
import com.java25.java25.springboot4.oracle.dto.MfaActivateDto;
import com.java25.java25.springboot4.oracle.services.TwoFactorAuthService;
...
public class ActivateMfa {
	...
	public ResponseEntity<Map<String, String>> mfaActivate(@RequestBody MfaActivateDto mfaDto, @PathVariable Long id) {    	
    	...
    	return userService.getUserById(id)
    			.map(user -> {		        	
    		    	...
    		    	if (mfaDto.isTwoFactorEnabled()) {
	    	            ...
	    	            String dataUri = twoFactorAuthService.getQRCodeUrl(secret, user.getEmail(), "WORLD TAEKWONDO");
